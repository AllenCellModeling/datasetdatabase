...
description = "modelingdbtools: scripts and functions to create and manage \
the modeling database"
# Long description will go up on the pypi page
long_description = """
modeling database tools
========
modeling database tools is the tools and functions library built to help
...
SCRIPTS = [
           "modelingdbtools/bin/create_modeling_db",
           "modelingdbtools/bin/display_modeling_db",
           "modelingdbtools/bin/backup_and_reset_db"
           ]
